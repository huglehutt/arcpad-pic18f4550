/* Joypad_main.c by hugot pichoon
* based on mouse.c by microchip
************************************/
/********************************************************************
 FileName:		mouse.c
...
//      #pragma config EBTR3    = OFF
        ...
        #pragma config PLLDIV   = 3         // (4 MHz crystal used on this board)
...
{   
    ...
    //Call the function that active joypad
    Joypad();
 ...
 *
 * Overview:       this function prepar the USB_stack to export data about
 *					the joypad
 *
 * Note:            
 *
